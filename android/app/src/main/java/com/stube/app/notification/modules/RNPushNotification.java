...
import com.stube.app.notification.helpers.ApplicationBadgeHelper;
...
public class RNPushNotification extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (bundle != null) {
            ...
            if (rightButton) {
                NotificationManager notiManager = (NotificationManager) this.reactContext.getSystemService(Context.NOTIFICATION_SERVICE);
