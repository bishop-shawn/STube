...
import com.stube.app.share.ShareFile;
import com.stube.app.share.ShareFiles;
...
public abstract class ShareIntent {
    ...
    protected ShareFile getFileShare(ReadableMap options) {
        ...
        if (ShareIntent.hasValidKey("filename", options)) {
            name = options.getString("filename");
        }
        if (ShareIntent.hasValidKey("type", options)) {
            return new ShareFile(options.getString("url"), options.getString("type"), name, this.reactContext);
        } else {
            return new ShareFile(options.getString("url"), name, this.reactContext);
        }
    }
