...
public class APlayerView extends TextureView
        implements TextureView.SurfaceTextureListener, AMediaPlayer.OnVideoSizeChangedListener {

    protected AMediaPlayer mMediaPlayer;
    ...
    public APlayerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    @Override
    public void onVideoSizeChanged(AMediaPlayer mp, int width, int height) {
    ...
    // public void setDataSource(@NonNull Context context, @NonNull Uri uri) throws
    // IOException {
    // initializeMediaPlayer();
    // mMediaPlayer.setDataSource(context, uri);
    // }

    // public void setDataSource(@NonNull FileDescriptor fd, long offset, long
    // length)
    //// throws IOException {
    //// initializeMediaPlayer();
    ...
    public void prepare(@Nullable AMediaPlayer.OnPreparedListener listener) throws IOException, IllegalStateException {
        mMediaPlayer.setOnPreparedListener(listener);
        mMediaPlayer.prepare();
    }

    public void prepareAsync(@Nullable AMediaPlayer.OnPreparedListener listener) throws IllegalStateException {
        mMediaPlayer.setOnPreparedListener(listener);
    ...
    public void setOnErrorListener(@Nullable AMediaPlayer.OnErrorListener listener) {
        mMediaPlayer.setOnErrorListener(listener);
    }

    public void setOnCompletionListener(@Nullable AMediaPlayer.OnCompletionListener listener) {
        mMediaPlayer.setOnCompletionListener(listener);
    }

    public void setOnInfoListener(@Nullable AMediaPlayer.OnInfoListener listener) {
