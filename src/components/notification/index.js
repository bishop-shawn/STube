...
Notifications.configure = function (options: Object) {
  ...
  if (typeof options.onNotificationCancel !== 'undefined') {
    this.onNotificationCancel = options.onNotificationCancel;
  }
  ...
  if (this.isLoaded === false) {
    ...
    this._onNotificationCancel = this._onNotificationCancel.bind(this);
    ...
    this.callNative('addEventListener', ['cancel', this._onNotificationCancel]);
...
Notifications.unregister = function () {
  ...
  this.callNative('removeEventListener', ['cancel', this._onNotificationCancel]);
...
Notifications._onNotificationCancel = function (notificationData: Object) {
  if (this.onNotificationCancel !== false) {
    this.onNotificationCancel(notificationData);
  }
};
