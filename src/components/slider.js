...
export default class Slider extends PureComponent {
  ...
  render() {
    var { minimumValue, maximumValue, minimumTrackTintColor, maximumTrackTintColor, thumbTintColor, thumbImage, styles, style, trackStyle, thumbStyle, debugTouchArea, ...other } = this.props;
    ...
    return (
      <View {...other} style={[mainStyles.container, style]} onLayout={this._measureContainer}>
        <View style={[{ backgroundColor: maximumTrackTintColor }, mainStyles.track, trackStyle]} renderToHardwareTextureAndroid={true} onLayout={this._measureTrack} />
        <Animated.View renderToHardwareTextureAndroid={true} style={[mainStyles.track, trackStyle, minimumTrackStyle]} />
        <Animated.View
        ...
        <View renderToHardwareTextureAndroid={true} style={[defaultStyles.touchArea, touchOverflowStyle]} {...this._panResponder.panHandlers}>
  ...
  _getPropsForComponentUpdate(props) {
    var { value, onValueChange, onSlidingStart, onSlidingComplete, style, trackStyle, thumbStyle, ...otherProps } = props;
    return otherProps;
  }
  ...
  _handleStartShouldSetPanResponder = (e: Object /*gestureState: Object*/): boolean => {
    ...
    this._setCurrentValue((e.nativeEvent.locationX - this._getThumbLeft(0) - this.props.thumbTouchSize.width / 2) / (this.state.containerSize.width - (this.props.thumbTouchSize.width - this.state.thumbSize.width) / 2));
  ...
  _getValue = (gestureState: Object) => {
    ...
    if (this.props.step) {
      return Math.max(
        ...
        Math.min(this.props.maximumValue, this.props.minimumValue + Math.round((ratio * (this.props.maximumValue - this.props.minimumValue)) / this.props.step) * this.props.step)
      );
    } else {
